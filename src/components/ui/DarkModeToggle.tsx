...
export function DarkModeToggle() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-white/10 to-white/20 shadow-inner" />

      <div
        className={`relative inline-flex h-6 w-6 transform items-center justify-center rounded-full bg-white shadow-lg transition-all duration-300 ease-in-out ${
